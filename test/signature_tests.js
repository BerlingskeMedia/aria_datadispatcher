...
describe('valid auth scheme', async () => {
  ...
  describe('test 2 with eventData', async () => {
  ...
  describe('test 3 with multiple floats', async () => {
...
describe('invalid auth scheme tests', async () => {
  ...
  it('missing requestDateTime throws 401 unauthorized', async () => {
    ...
    try {
      const concatenatedValue = scheme.concatMsgAuthDetails({ msgAuthDetails: invalidMsgAuthDetails });
